...
MultiSKAT_NULL_Fast<-function(y.mat, X, is.fast=TRUE) {
  ...
  re<-list(res = res, res.V = res.V, V.item.inv = V.item.inv, X1=X1, XVX1_inv=XVX1_inv, n.pheno=n.pheno, q1=q1, n.all=n, id_include=1:n,y.Corr = Corr,y.Cov = Cov,pc.Cov = V_p,L = L, V.item=V.item)
